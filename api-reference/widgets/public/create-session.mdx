...
This endpoint accepts the widget's client secret via the `X-Client-Secret` header.
...
```shell
curl --request POST 'https://payments.bleepay.com/api/v1/widgets/deposit-sessions/create-session' \
