...
A liquidation address is a single-purpose crypto address: crypto in → fiat out to a preset bank account, created per payment by the partner. Because a fiat payout is involved, the receiving merchant completes KYC/KYB (see [Onboarding and KYC/KYB](/architecture/onboarding-kyc-kyb)).
...
* [How money moves](/architecture/how-money-moves) — who holds funds at each step.
