...
- In the **Bleepay Wallet**, the user controls their own funds. Bleepay generates the transactions linked to a voucher; the user **signs and broadcasts them from the iOS app** with their own keys (Android planned).
...
<ThemeImage img_name="BleepayWallet-non-custodial.png" alt="Bleepay Wallet non-custodial.png" />

<ThemeImage img_name="WidgetGateway-non-custodial.png" alt="Bleepay Wallet non-custodial.png" />
