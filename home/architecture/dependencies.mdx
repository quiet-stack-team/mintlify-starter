...
An **established bridge protocol** is the current default, selected for reliability and speed. The **bridging layer** is modular: alternative protocols can be plugged in to:
...
| Provider type | Role |
| --- | --- |
| **Fiat off-ramp partners** (regulated providers) | Create and operate liquidation addresses, convert crypto→fiat, send fiat to bank accounts |
