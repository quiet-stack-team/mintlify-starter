...
<ThemeImage
    img_name="Widget-deposit-same-token.png"
    alt="Widget deposit (same token)"
/>
...
<ThemeImage
    img_name="Voucher-payment-6-digit-code.png"
    alt="Voucher payment (6-digit code)"
/>
...
<ThemeImage
    img_name="FX-crypto-crypto.png"
    alt="FX crypto-crypto"
/>
