...
2. **A liquidation address is created** — Bleepay contacts a fiat off-ramp partner, which returns a dedicated crypto deposit address configured to convert incoming crypto to fiat and pay the bank account.
