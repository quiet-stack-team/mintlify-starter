...
- For Web2 mode (in development): fiat bank payouts (e.g. SEPA/ELIXIR) via regulated partners.
...
- Simplifies accounting: you receive stablecoin (or fiat, once payouts launch), not a basket of tokens.
