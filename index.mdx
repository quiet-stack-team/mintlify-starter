...
<Frame>
  ...
  <img
    ...
    lightAlt="184"
    darkAlt="184"
    src="/images/184-2.png"
    className="hidden dark:block"
  />
</Frame>

> Non-custodial payment orchestration connecting Web3 liquidity to traditional fiat rails. Pay with any token; merchants receive stablecoins today, with fiat payouts in development.

Pay with a **6-digit code**. No extensions. No wallet popups. Crypto in, stablecoins out.

## Why Bleepay?

Bleepay is a **non-custodial orchestration layer** that connects Web3 liquidity to traditional fiat rails. Users pay with **any token on any chain** via human-friendly **6-digit codes**; merchants settle in **stablecoins** today, with **fiat payouts to bank accounts in development** through regulated partners.
...
- **Fiat payouts in development** — bank payouts (IBAN via SEPA/ELIXIR) are being built with regulated partners; merchants settle in stablecoins today
...
- [Overview](/home/e-commerce/overview) — Accept crypto at checkout; stablecoin settlement today, fiat in development
