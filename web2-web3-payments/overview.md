...
* [Simple Payments](/web2-web3-payments/simple-payments) — create a single EURC payment with SIMPLE voucher.
* [Sessions](/web2-web3-payments/sessions) — group multiple vouchers in a session.
* [Smart Contracts](/web2-web3-payments/smart-contracts) — interact with contracts via CUSTOM vouchers.
